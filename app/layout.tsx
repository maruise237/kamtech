...
export const metadata: Metadata = {
  ...
  generator: "v0.app",
  keywords: ["chatbot WhatsApp", "automatisation IA", "PME", "conversion", "chatbot IA", "WhatsApp bot", "automatisation marketing", "AI chatbot", "AI automation", "SME"],
  openGraph: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description: "Automatisation WhatsApp & Chatbot IA pour PME / AI WhatsApp Automation & Chatbot for SMEs",
  }
